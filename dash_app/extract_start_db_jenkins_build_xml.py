...
parser.add_argument("--InputDir", help = "Input file to extract Jenkins Job file", required = False, default = "C:\\projects\\small_projects\\RX-9110\\2023-10-25a_rx_fx_jenkins_jenkins_jobs\\jobs\\start db fabrication\\builds")     
