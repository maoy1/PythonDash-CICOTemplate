...
parser.add_argument("--InputFile", help = "Input file to extract Jenkins Job file", required = False, default = "data/00begin_ended_2017-11-22_until_2023-10-13_with_some_gaps_xfrun_errlog.log")     
parser.add_argument("--Output", help = "The Jenkins Job CSV data file", required = False, default = "data/jenkins_jobs.csv")     
...
pd.DataFrame(flattened_steps).to_csv(output_file, columns=["batch","name","start_time","end_time","duration","duration_string","parent","isLeaf"])